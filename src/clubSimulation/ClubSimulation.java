...
public class ClubSimulation {
	...
	static int gridX=100; //number of x grids in club - default value if not provided on command line
	static int gridY=100; //number of y grids in club - default value if not provided on command line
